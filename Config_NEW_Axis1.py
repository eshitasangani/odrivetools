...
#is 83 amps
odrv0.axis1.motor.config.requested_current_range = 80 #increases the range, must reboot to execute this
odrv0.axis1.motor.config.current_lim = 75
#velocity limit turn/s. 54 is the max our motor should ever go
odrv0.axis1.controller.config.vel_limit = 54
...
#torque constant
odrv0.axis1.motor.config.torque_constant = 52.5 # TODO: ensure this is correct
#motor type
odrv0.axis1.motor.config.motor_type = MOTOR_TYPE_HIGH_CURRENT #DEBUG: this line might be missing a [0] parameter
# should be less than 0.5 * DC bus voltage. 
odrv0.axis1.motor.config.resistance_calib_max_voltage = 10.0 
odrv0.axis1.motor.config.current_control_bandwidth = 100 #TODO: figure this out
...
odrv0.axis1.encoder.config.calib_scan_distance = 150.1 
#specify the hall pins as digital pins
odrv0.config.gpio9_mode = GPIO_MODE_DIGITAL
odrv0.config.gpio10_mode = GPIO_MODE_DIGITAL
odrv0.config.gpio11_mode = GPIO_MODE_DIGITAL
odrv0.axis1.encoder.config.bandwidth = 100 #TODO: figure out this line and the three above
###
...
#odrv0.axis1.encoder.config.mode = ENCODER_MODE_ABSOLUTE
